...
public class POFactory {
    ...
    //if field is component create instance of it
    //Set the xpath to the components, need to know what type of driver we need - add isAndroid and isIOS methods in driver class
