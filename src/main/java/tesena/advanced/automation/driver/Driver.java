...
public class Driver {
    ...
    public void scrollToElement(Component component) {
        ...
        int counter = 0;
        while (counter++ <10) {
            touchAction.longPress(PointOption.point((int) (widht * 0.5), (int) (height * 0.8)))
                    .moveTo(PointOption.point((int) (widht * 0.5), (int) (height * 0.3)))
                    .release()
                    .perform();
    ...
    //solves the problem with hidden existing elements
